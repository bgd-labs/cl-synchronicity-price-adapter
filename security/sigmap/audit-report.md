...
The purpose of the contract is to reduce the impact of lag time when multiple stablecoins (USD) have different price feeds.
...
One informational finding and two miscellaneous findings were found during the review posing negligible security risks.
...
A Chainlink feed will have a default of 8 decimal places thus this implies an erroneous or malicious configuration.
